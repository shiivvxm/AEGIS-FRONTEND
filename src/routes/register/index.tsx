  ...
  head: () => ({
    meta: [
      { title: "Select Role · AEGIS Registration" },
      {
        name: "description",
        content:
          "Select your role to register on the AEGIS Emergency Response Platform. Citizen, Hospital, Ambulance Driver, Volunteer, Command Center Officer, or Traffic Police.",
      },
    ],
  }),
...
const REGISTER_ROLES: RoleCard[] = [
  {
    ...
    description:
      "Broadcast instant SOS alerts, track dispatch vectors, and secure your personal emergency medical file.",
    icon: HeartPulse,
    color: "text-[#E63946]",
  ...
  },
  {
    ...
    description:
      "Coordinate nearby distress alerts, perform basic first-aid/CPR, and claim community service points.",
    icon: Users,
  ...
  },
  {
    ...
    description:
      "Sync navigation routes, stream active patient vitals directly to ER trauma hubs, and request green corridor traffic priority.",
    icon: Ambulance,
  ...
  },
  {
    ...
    description:
      "Manage live ICU bed capacity, accept emergency patient streams, and alert surgical teams in advance.",
    icon: Building2,
    color: "text-blue-600",
  ...
  },
  {
    ...
    description:
      "Monitor city traffic map, manage emergency green corridors, and inspect live CCTV feeds.",
    icon: TrafficCone,
  ...
  },
  {
    ...
    description:
      "Monitor city-wide emergency heatmaps, manage resource dispatches, and trigger green corridor overrides.",
    icon: Shield,
      ...
      <div className="w-full max-w-xl relative z-10 space-y-8">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-extrabold tracking-tight text-gray-900">
            Create AEGIS Account
          </h1>
          <p className="text-sm text-gray-500 max-w-md mx-auto">
            Choose your specialization profile below. Each account role operates on a verified,
            secure clearance level.
          </p>
        </div>
        ...
        <div className="space-y-3">
          {REGISTER_ROLES.map((role) => {
            ...
            return (
              ...
              >
                <div
                  className={`h-11 w-11 rounded-xl flex items-center justify-center shrink-0 bg-white border border-gray-100 shadow-sm ${role.color} group-hover:scale-105 transition-transform`}
                >
