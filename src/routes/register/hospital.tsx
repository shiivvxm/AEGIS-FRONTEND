...
const hospitalSchema = z
  .object({
    ...
    accreditationUpload: z
      .any()
      .refine(
        (val) => val !== null && val !== undefined,
        "Hospital clinical accreditation doc is required",
      ),
    consent: z
      .boolean()
      .refine((val) => val === true, "Consent to real-time bed capacity reporting is required"),
  })
            ...
            <div className="text-center py-8 space-y-4 animate-fade-in">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Activating live bed capacity reports and trauma notifications...
                </p>
              </div>
            ...
            <form onSubmit={handleSubmit(onSubmit, onInvalidSubmit)} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      {errors.registrationNumber && (
                        <p className="text-[10px] text-red-500 font-bold mt-1">
                          ⚠️ {errors.registrationNumber.message}
                        </p>
                      )}
                    </div>
                    <div>
                ...
                <div className="space-y-4 animate-fade-in">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      {errors.hospitalType && (
                        <p className="text-[10px] text-red-500 font-bold mt-1">
                          ⚠️ {errors.hospitalType.message}
                        </p>
                      )}
                    </div>
                    <div>
                      <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">
                        Trauma Center Active?
                      </label>
                      <select
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      {errors.icuCapacity && (
                        <p className="text-[10px] text-red-500 font-bold mt-1">
                          ⚠️ {errors.icuCapacity.message}
                        </p>
                      )}
                    </div>
                    <div>
                      <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">
                        Emergency Bays Capacity
                      </label>
                      <input
                        type="number"
                        {...register("erCapacity")}
              ...
              {step === 3 && (
                <div className="space-y-4 animate-fade-in">
                  ...
                  />
                  {errors.accreditationUpload && (
                    <p className="text-[10px] text-red-500 font-bold">
                      ⚠️ {errors.accreditationUpload.message}
                    </p>
                  )}
                  ...
                  <div className="pt-2">
                    <label className="flex items-start gap-3 cursor-pointer p-3 rounded-xl bg-gray-50 border border-gray-100 hover:bg-gray-100/60 transition-colors">
                      ...
                      <span className="text-[10px] leading-relaxed text-gray-500 font-semibold uppercase tracking-wide">
                        We agree to report real-time ICU bed and ER bay occupancy statuses to the
                        AEGIS dispatcher network, ensuring coordinate divert triggers operate
                        accurately.
                      </span>
                    </label>
                    {errors.consent && (
